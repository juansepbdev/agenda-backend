...
class Client(CompanyOwnedModel):
    class Source(models.TextChoices):
        CHATBOT = "CHATBOT", "Chatbot"; MANUAL = "MANUAL", "Manual"; WEBSITE = "WEBSITE", "Website"; PHONE_CALL = "PHONE_CALL", "Phone call"; OTHER = "OTHER", "Other"
    class Channel(models.TextChoices):
        WHATSAPP = "WHATSAPP", "WhatsApp"; PHONE = "PHONE", "Phone"; EMAIL = "EMAIL", "Email"
